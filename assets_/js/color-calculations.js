 ...
 * @return {Object} - this
 */
function _MayLoeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_MayLoeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_MayLoeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_MayLoeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _MayLoeColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function MayLoeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _MayLoeColor( backgroundColor, accentHue );
